...
const ESCENARIOS = {
    ...
    EQUIPO_TACTICO:     { label: 'EQUIPO — TÉCNICA', emoji: '🎯', color: '#659499',
        ejercicios: [69, 70, 71, 34],
        desc: 'Práctica técnica/táctica con el equipo. Registrá carga al terminar.' },
    EQUIPO_FISICO:      { label: 'EQUIPO — FÍSICO', emoji: '🏃', color: '#385560',
        ejercicios: [109, 110, 36, 72, 35],
        desc: 'Sesión física del equipo: velocidad, resistencia, cambios de ritmo.' },
