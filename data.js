...
const ESCENARIOS = {
    ...
    /* ── Protocolos de salud y readaptación ── */
    DESCANSO_SALUD:   { label: 'DESCANSO POR SALUD', emoji: '🤒', color: '#6b7280',
        ejercicios: [],
        desc: 'Día registrado como baja por enfermedad. Sin carga.' },
    MOVILIDAD_SUAVE:  { label: 'MOVILIDAD SUAVE', emoji: '🧘', color: '#a78bfa',
        ejercicios: [55, 56, 59, 64, 60, 63],
        desc: 'Movilidad articular muy suave. Solo con síntomas leves. RPE máx 3.' },
    READAPTACION:     { label: 'READAPTACIÓN', emoji: '🌱', color: '#34d399',
        ejercicios: [97, 9, 90, 89, 34, 55, 56],
        desc: 'Retorno post-enfermedad. Volumen reducido, RPE máx 5-6. Sin cargas máximas.' },
