...
OBJETIVOS_DISPONIBLES.push(
    ...
    { id: 'DUAL_FUTBOL', categoria: 'DUAL', moduloDeportivo: 'dual',
      ...
      dayScenario: { 0:'PARTIDO', 1:'RECUPERACION', 2:'EQUIPO_TACTICO', 3:'GYM_FUERZA_INF', 4:'EQUIPO_FISICO', 5:'GYM_PREVENCION', 6:'ACTIVACION_PRE' },
    },
    ...
    { id: 'DUAL_RUGBY', categoria: 'DUAL', moduloDeportivo: 'dual',
      ...
      dayScenario: { 0:'PARTIDO', 1:'RECUPERACION', 2:'EQUIPO_FISICO', 3:'GYM_FUERZA_INF', 4:'EQUIPO_TACTICO', 5:'GYM_FUERZA_SUP', 6:'ACTIVACION_PRE' },
    },
    { id: 'DUAL_BALONCESTO', categoria: 'DUAL', moduloDeportivo: 'dual',
      ...
      dayScenario: { 0:'PARTIDO', 1:'RECUPERACION', 2:'EQUIPO_TACTICO', 3:'GYM_POTENCIA', 4:'EQUIPO_FISICO', 5:'GYM_PREVENCION', 6:'ACTIVACION_PRE' },
    },
    { id: 'DUAL_HANDBALL', categoria: 'DUAL', moduloDeportivo: 'dual',
      ...
      dayScenario: { 0:'PARTIDO', 1:'RECUPERACION', 2:'EQUIPO_TACTICO', 3:'GYM_FUERZA_SUP', 4:'EQUIPO_FISICO', 5:'GYM_PREVENCION', 6:'ACTIVACION_PRE' },
    },
    { id: 'DUAL_TENIS', categoria: 'DUAL', moduloDeportivo: 'dual',
      ...
      dayScenario: { 0:'DESCANSO', 1:'GYM_FUERZA_INF', 2:'EQUIPO_TACTICO', 3:'GYM_PREVENCION', 4:'EQUIPO_FISICO', 5:'GYM_POTENCIA', 6:'ACTIVACION_PRE' },
    },
    { id: 'DUAL_ATLETISMO', categoria: 'DUAL', moduloDeportivo: 'dual',
      ...
      dayScenario: { 0:'DESCANSO', 1:'GYM_FUERZA_INF', 2:'EQUIPO_FISICO', 3:'GYM_PREVENCION', 4:'EQUIPO_TACTICO', 5:'GYM_POTENCIA', 6:'ACTIVACION_PRE' },
    },
    { id: 'DUAL_NATACION', categoria: 'DUAL', moduloDeportivo: 'dual',
      ...
      dayScenario: { 0:'DESCANSO', 1:'GYM_FUERZA_SUP', 2:'EQUIPO_FISICO', 3:'GYM_PREVENCION', 4:'EQUIPO_TACTICO', 5:'GYM_POTENCIA', 6:'ACTIVACION_PRE' },
    },
    // ── HÍBRIDO Tipo C ──
...
const ESCENARIOS = {
    ...
    /* ── DUAL: Escenarios integrados deporte+gym ── */
    EQUIPO_TACTICO:  { label: 'EQUIPO — TÉCNICA', emoji: '🎯', color: '#659499',
        ejercicios: [31, 32, 33],
        desc: 'Práctica técnica/táctica con el equipo. Carga técnica moderada.' },
    EQUIPO_FISICO:   { label: 'EQUIPO — FÍSICO', emoji: '🏃', color: '#385560',
        ejercicios: [34, 35, 36],
        desc: 'Sesión física con el equipo. Cardio, velocidad, resistencia.' },
    GYM_FUERZA_INF:  { label: 'GYM — FUERZA INF', emoji: '🏋️', color: '#eab731',
        ejercicios: [6, 7, 8, 9, 11, 27],
        desc: 'Fuerza tren inferior en sala. Priorizá sentadilla y peso muerto.' },
    GYM_FUERZA_SUP:  { label: 'GYM — FUERZA SUP', emoji: '💪', color: '#bc9d4b',
        ejercicios: [1, 4, 5, 17, 23, 24],
        desc: 'Fuerza tren superior en sala. Empuje + tracción.' },
    GYM_POTENCIA:    { label: 'GYM — POTENCIA', emoji: '⚡', color: '#da7a0e',
        ejercicios: [6, 8, 52, 36, 40, 27],
        desc: 'Potencia explosiva. Saltos, kettlebell, sentadilla rápida.' },
    GYM_PREVENCION:  { label: 'GYM — PREVENCIÓN', emoji: '🛡️', color: '#22c55e',
        ejercicios: [24, 22, 28, 27, 50, 3],
        desc: 'Trabajo preventivo en sala. Manguito, aductores, core.' },
    ACTIVACION_PRE:  { label: 'ACTIVACIÓN PRE-PARTIDO', emoji: '🔆', color: '#f59e0b',
        ejercicios: [34, 28, 24, 22],
        desc: 'Activación liviana pre-partido. RPE máx 5. Sin fatiga acumulada.' },

    /* ── BOXEO: Escenarios híbrido Tipo C ── */
    BOXEO_SALA:     { label: 'BOXEO — SALA', emoji: '🏋️', color: '#dc2626',
        ejercicios: [6, 1, 19, 38, 39, 27],
        desc: 'Trabajo de fuerza y acondicionamiento en sala.' },
    BOXEO_TECNICA:  { label: 'BOXEO — TÉCNICA', emoji: '🥊', color: '#ef4444',
        ejercicios: [34, 38, 28],
        desc: 'Técnica de golpes, trabajo de pies, saco/bolsa. Carga media.' },
...
const EJERCICIOS_FUGA = [
    ...
    { cod: 24, nombre: 'Face-Pull',              grupo: 'Hombro',   series: 3, reps: '15', desc: 'Prevención manguito rotador' },
    { cod: 27, nombre: 'Copenhagen Plank',       grupo: 'Core',     series: 3, reps: '30s', desc: 'Prevención aductores' },
...
function _generateDualPlan(objetivoId, onboarding) {
    ...
    const diaPrePartido  = (diaPartido + 6) % 7;
    ...
    function buildWeekMap(w) {
        ...
        map[diaPrePartido]  = 'ACTIVACION_PRE';

        if (isTorneoWeek) {
            // Semana de torneo: solo prevención y activación
            for (let d = 0; d < 7; d++) {
        ...
        // Días libres ordenados por posición en semana
        const libres = [];
        for (let d = 0; d < 7; d++) { if (!map[d]) libres.push(d); }

        // Equipo primero (máx diasEquipo días)
        let equipoCount = 0;
        ...
        // Gym en lo que queda (máx diasGym)
        let gymCount = 0;
    ...
    for (let w = 0; w < obj.duracionSemanas; w++) {
        ...
        for (let d = 0; d < 7; d++) {
            const fecha    = _addDays(PLAN_START_DATE, w * 7 + d);
            const escenario = weekMap[d] || 'DESCANSO';
