...
const UserSystem = (() => {
    ...
    function _generatePlan(objetivoId) {
        ...
        if (onboarding) {
            ...
            const combinedFactor = Math.max(0.70, volFactor * nivelFactor * tempFactor);
        ...
        if (mvolEl) {
            if (fatigue.vol > 0) {
                ...
                const cargaTotal = DB.getRegistro()
                    .filter(e => { const c = new Date(); c.setDate(c.getDate()-7); return e.fecha >= c.toISOString().split('T')[0]; })
...
const LoginUI = {
    ...
    _stepsBase: [
        {
            id: 'frecuenciaUlt7d',
            title: '¿Cuántas sesiones completaste en los últimos 7 días?',
            emoji: '📅',
            desc: 'Queremos saber de dónde venís, no adónde querés llegar.',
            options: [
        ...
        },
        {
            ...
            title: '¿Cuántos días por semana podés comprometerte?',
            emoji: '🗓️',
            desc: 'Sé realista — mejor poco y constante que mucho y abandonado.',
            options: [
                { label: '2 días', val: '2' },
                { label: '3 días', val: '3' },
                { label: '4 días', val: '4' },
                { label: '5 o más días', val: '5' },
            ]
        },
        {
            id: 'diaDescanso',
            title: '¿Qué día preferís descansar?',
            emoji: '🛌',
            desc: 'El plan va a respetar este día siempre.',
            options: [
                { label: 'Lunes', val: '1' },
        ...
        {
            id: 'nivel',
            title: '¿Cómo calificarías tu nivel en sala?',
            emoji: '💪',
            desc: 'Esto ajusta la carga de trabajo de las primeras semanas.',
            options: [
        ...
        {
            id: 'equipamiento',
            title: '¿Qué equipamiento tenés disponible?',
            emoji: '🏋️',
            desc: 'Filtramos ejercicios que no podés hacer.',
            options: [
        ...
        },
        {
            ...
            title: '¿Cuál es tu objetivo de cuerpo ahora mismo?',
            emoji: '🎯',
            desc: 'Calibra volumen, intensidad y foco del plan.',
            options: [
        ...
        },
        {
            ...
            title: '¿Tenés alguna zona que cuidar o lesión reciente?',
            emoji: '🩺',
            desc: 'El plan evita cargar esa zona en exceso.',
            options: [
        ...
        {
            id: 'recuperacion',
            title: '¿Cómo venís durmiendo y manejando el estrés?',
            emoji: '😴',
            desc: 'El sueño y el estrés impactan directo en la recuperación muscular.',
            options: [
    ...
    _stepsDeporte: [
        {
            id: 'diaPartido',
            title: '¿Qué día suele ser tu partido o competencia?',
            emoji: '🏟️',
            desc: 'Organizamos la semana para que llegues fresco al partido.',
            options: [
                { label: 'Domingo', val: '0' },
                { label: 'Sábado', val: '6' },
                { label: 'Viernes', val: '5' },
                { label: 'Variable / no fijo', val: '-1' },
            ]
        },
        {
    ...
    _stepsDual: [
        {
            id: 'diaPartido',
            title: '¿Qué día es tu partido o competencia principal?',
            emoji: '🏟️',
            desc: 'El día de partido, recuperación y activación se fijan alrededor de este.',
            options: [
                { label: 'Domingo', val: '0' },
                { label: 'Sábado', val: '6' },
                { label: 'Viernes', val: '5' },
        ...
        {
            id: 'diasEquipo',
            title: '¿Cuántos días por semana entrenás con el equipo / en cancha?',
            emoji: '⚽',
            desc: 'El gym se distribuye en los días que quedan libres.',
            options: [
                { label: '1 día', val: '1' },
                { label: '2 días', val: '2' },
                { label: '3 días', val: '3' },
        ...
        {
            id: 'diasGym',
            title: '¿Cuántos días podés dedicar al gimnasio?',
            emoji: '🏋️',
            desc: 'Sumados a los de equipo, no deben superar tu disponibilidad total.',
            options: [
                { label: '1 día', val: '1' },
                { label: '2 días', val: '2' },
                { label: '3 días', val: '3' },
    ...
    _stepsHibrido: [
        {
            id: 'diasSala',
            title: '¿Cuántos días por semana hacés trabajo de sala (pesas)?',
            emoji: '🏋️',
            desc: 'Esto define cuántas sesiones de fuerza tiene tu semana.',
            options: [
                { label: '2 días', val: '2' },
                { label: '3 días', val: '3' },
                { label: '4 días', val: '4' },
