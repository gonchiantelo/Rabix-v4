    ...
    function initAdmin() {
        ...
        if (!existing) {
            ...
            const admin = {
                ...
                onboarding: {
                    frecuenciaUlt7d: '3', nivel: 'avanzado', duracionSesion: '60',
...
const LoginUI = {
            ...
            newUserForm.addEventListener('submit', e => {
                ...
                try {
                    ...
                    if (newUser && !newUser.onboarding) {
                        newUser.onboarding = {
                            frecuenciaUlt7d: '3', disponibilidadDias: '4',
                            nivel: 'intermedio', duracionSesion: '60',
                            recuperacion: 'media', diaPartido: '-1', diaDescanso: '-1'
                        };
    ...
    _stepsBase: [
        ...
        {
            id: 'duracionSesion',
            title: 'Duración media por sesión de gimnasio',
            options: [
        ...
        {
            id: 'recuperacion',
            title: '¿Cómo venís recuperando (sueño/estrés)?',
            options: [
                { label: 'Alta — duermo bien, bajo estrés', val: 'alta' },
                { label: 'Media', val: 'media' },
                { label: 'Baja — fatigado o estresado', val: 'baja' }
            ]
        },
    ],

    // Steps extra para objetivos con partido/competencia
    _stepsDeporte: [
        {
            id: 'diaPartido',
    ...
    // Steps específicos para plan DUAL
    _stepsDual: [
        {
            id: 'diaPartido',
        ...
        {
            id: 'objetivoGym',
            title: '¿Cuál es tu objetivo principal en el gimnasio?',
            options: [
                { label: '💪 Fuerza — más potencia y carga', val: 'fuerza' },
                { label: '⚡ Potencia explosiva — saltos, velocidad', val: 'potencia' },
                { label: '🛡️ Prevención — evitar lesiones', val: 'prevencion' },
            ]
        },
    ],

    // Steps para deportes híbridos (Boxeo Tipo C)
    _stepsHibrido: [
        {
            id: 'diasSala',
