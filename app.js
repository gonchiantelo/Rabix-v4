...
const UserSystem = (() => {
    ...
    function _generatePlan(objetivoId) {
        ...
        if (onboarding) {
            ...
            // 4. Factor combinado (no acumular más del 30% de reducción)
            const combinedFactor = Math.max(0.70, volFactor * nivelFactor * tempFactor * ageFactor);
...
const UI = (() => {
    ...
    function openLogModal(cod) {
        ...
        if (onboarding) {
            ...
            // Older athletes: start conservatively
