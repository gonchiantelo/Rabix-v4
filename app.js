...
const UI = (() => {
    ...
    function buildExerciseCard(exData) {
        ...
        const weightStr = (ej.fatiga === 1 && suggestedWeight === 0) ? 'Peso corporal'
                        : `${suggestedWeight} kg${isProgressed ? ' ▲' : ''}`;
    ...
    function initGlobalListeners() {
        ...
        // Scenario override y objetivo ahora están en Configuración (more menu → advanced settings)
    ...
    window.UI._renderCustomExList = _renderCustomExList;
    window.UI._resetCustomExForm = _resetCustomExForm;
    window.UI._calcAutoFatiga = _calcAutoFatiga;
    window.UI = {
