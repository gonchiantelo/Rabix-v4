...
const LoginUI = {
    ...
    // Picker state
    _pickerLevel: 0,       // 0=categorías, 1=subcategorías, 2=niveles
    _pickerCat: null,      // categoría seleccionada
    _pickerSub: null,      // subcategoría seleccionada (ej: FUTBOL)
    ...
    renderObjetivoPicker() {
        ...
        if (this._pickerLevel === 0) {
            this._renderPickerCats(picker);
        } else if (this._pickerLevel === 1) {
            this._renderPickerSubs(picker);
        } else {
            this._renderPickerNiveles(picker);
        }
    },
