...
const OBJETIVOS_DISPONIBLES = [
    ...
    /* ══════════ DEPORTES — Otros (genéricos) ══════════ */
    {
        ...
        desc: 'Agilidad, potencia de golpe y resistencia en cancha.',
        rpeYellow: 7.0, rpeRed: 8.5, duracionSemanas: 12,
        dayScenario: { 1: 'FUERZA_BASE', 2: 'HIIT', 3: 'PREVENCION', 4: 'DESCANSO', 5: 'FUERZA_BASE', 6: 'CARDIO_LARGO', 0: 'DESCANSO' },
        fases: [
            { num: 1, nombre: 'Base Física', color: '#84cc16', semanas: [1, 4] },
            { num: 2, nombre: 'Potencia', color: '#65a30d', semanas: [5, 8] },
            { num: 3, nombre: 'Competición', color: '#4d7c0f', semanas: [9, 12] },
        ],
        metricaLabel: 'Sesiones',
    },
    {
...
function _generatePlan(objetivoId) {
    ...
    for (let w = 0; w < obj.duracionSemanas; w++) {
        for (let d = 0; d < 7; d++) {
            ...
            let escenario = obj.dayScenario[dow] || 'DESCANSO';
